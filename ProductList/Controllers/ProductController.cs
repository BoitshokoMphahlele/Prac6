...
namespace ProductList.Controllers
    ...
    public class ProductController : Controller
        ...
        public ActionResult GetCategoryBySupplier(int supplierId)
        {
            ...
            return Content(
                string.Format("{0};{1}", string.Join(",", categoryNames), string.Join(",", categoryId)),
                "text/plain"
            );
        ...
        public ActionResult AddProduct(int productId, string productName, int serialNumber)
            {
